...
public class OsciPrime extends Activity {
	...
	private RadioGroup mRGmaxSelect;
	private RadioGroup mRGtiSelect;
	...
	public void onCreate(Bundle savedInstanceState) {
				...
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(RadioGroup group, int checkedId) {
						if (mRadioSourceSelection.isEnabled()) {
							...
							case R.id.source_fpga:
								l("Source fpga clicked");
								if (mServiceMessenger != null) {
									try {
										mServiceMessenger.send(Message.obtain(
												null, OPC.AS_SET_SOURCE,
		...
		mRGmaxSelect = (RadioGroup)findViewById(R.id.radioGroup1);
		mRGmaxSelect.setOnCheckedChangeListener( new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup arg0, int arg1) {
				...
				case R.id.radioButton1:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_MAX_CH_SELECT, 0, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
				...
				case R.id.radioButton2:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_MAX_CH_SELECT, 1, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
		...
		mRGtiSelect = (RadioGroup)findViewById(R.id.radioGroup2);
		mRGtiSelect.setOnCheckedChangeListener( new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup arg0, int arg1) {
				...
				case R.id.RadioButton01:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_TI_CH_SELECT, 0, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
				...
				case R.id.RadioButton02:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_TI_CH_SELECT, 1, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
				...
				case R.id.RadioButton03:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_TI_CH_SELECT, 2, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
				...
				case R.id.RadioButton04:
					if (mServiceMessenger != null) {
						try {
							mServiceMessenger.send(Message.obtain(null,	OPC.AS_SET_TI_CH_SELECT, 3, 0));
						} catch (RemoteException e) {
							e("could not send message to service, seems to be dead");
							e.printStackTrace();
						}
