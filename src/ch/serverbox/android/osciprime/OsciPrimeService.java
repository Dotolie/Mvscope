...
import ch.serverbox.android.osciprime.sources.FpgaSource;
...
public class OsciPrimeService extends Service {
	...
	private class ServiceHandler extends Handler{
		...
		public void handleMessage(Message msg) {
			...
			case OPC.AS_QUERY_PREFERENCES:
				pushPreferences();
				break;
			case OPC.AS_SET_MAX_CH_SELECT:
				switch(msg.arg1) {
				case 0:
					mCurrentSource.sendCommand((byte)0x10);
					break;
				case 1:
					mCurrentSource.sendCommand((byte)0x11);
					break;
				}
				break;
			case OPC.AS_SET_TI_CH_SELECT:
				switch(msg.arg1) {
				case 0:
					mCurrentSource.sendCommand((byte)0x20);
					break;
				case 1:
					mCurrentSource.sendCommand((byte)0x21);
					break;
				case 2:
					mCurrentSource.sendCommand((byte)0x22);
					break;
				case 3:
					mCurrentSource.sendCommand((byte)0x23);
					break;
				}
				break;
	...
	private void switchSource(int newSource){
		...
		case OPC.SOURCE_USB:
			...
			break;
		case OPC.SOURCE_FPGA:
			mCurrentSource = new FpgaSource(mServiceHandler,mPreferences);
			break;
		default:
			l("EXTREMEERROR!!!!!!!!!!!!!!!!!!!!!");
			return;
	...
	private int sourceFromPreferences(){
		...
		return sp.getInt("source", OPC.SOURCE_FPGA);
	}
